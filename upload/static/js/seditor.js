	...
	if(!$(menuid)) {
		switch(tag) {
			case 'at':
				...
				str = 'Vui lòng nhập tên người dùng:<br /><input type="text" id="atkeyword" style="width:240px" value="" class="px" onkeydown="atFilter(this.value, \'at_list\',\'atListSet\',event);" /><div class="p_pop" id="at_list" style="width:250px;"><ul><li>@tài khoản bạn bè, bạn có thể nhắc anh ấy đọc bài đăng</li></ul></div>';
				submitstr = 'seditor_insertunit(\'' + seditorkey + '\', \'@\' + $(\'atkeyword\').value.replace(/<\\/?b>/g, \'\')+\' \'); hideMenu();';
				break;
			case 'url':
				str = 'Vui lòng nhập địa chỉ liên kết:<br /><input type="text" id="' + ctrlid + '_param_1" sautocomplete="off" style="width: 98%" value="" class="px" />' +
			...
			case 'code':
			case 'quote':
				var tagl = {'quote' : 'Vui lòng nhập trích dẫn để chèn', 'code' : 'Vui lòng nhập mã để chèn'};
					str = tagl[tag] + ':<br /><textarea id="' + ctrlid + '_param_1" style="width: 98%" cols="50" rows="5" class="txtarea"></textarea>';
				submitstr = "seditor_insertunit('" + seditorkey + "', '[" + tag + "]'+$('" + ctrlid + "_param_1').value, '[/" + tag + "]', null, 1);hideMenu();";
				break;
			case 'img':
				str = 'Vui lòng nhập địa chỉ hình ảnh:<br /><input type="text" id="' + ctrlid + '_param_1" style="width: 98%" value="" class="px" onchange="loadimgsize(this.value, \'' + seditorkey + '\',\'' + tag + '\')" />' +
					'<p class="mtm">Chiều rộng (tùy chọn): <input type="text" id="' + ctrlid + '_param_2" style="width: 15%" value="" class="px" /> &nbsp;' +
					'Chiều cao (tùy chọn): <input type="text" id="' + ctrlid + '_param_3" style="width: 15%" value="" class="px" /></p>';
