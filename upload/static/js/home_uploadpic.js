...
function insertAttach(id) {
	...
	if(typeof no_insert=='undefined') {
		localfile += '&nbsp;<a href="javascript:;" class="xi2" title="Nhấn vào đây để chèn nội dung vào vị trí con trỏ hiện tại" onclick="insertAttachimgTag(' + id + ');return false;">[Chèn]</a>';
	}
...
function upload() {
	...
	if(nowUid>0) {
		...
		if(uploadStat==1) {
			upobj.innerHTML = 'Tải lên thành công';
			successState = true;
			var InputNode;
			try {
