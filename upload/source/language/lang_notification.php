...
Tích lũy {warningexpiration} cảnh báo trong {warninglimit} ngày liên tiếp và bạn sẽ tự động bị cấm phát biểu trong {warningexpiration} ngày.<br />
Cho đến nay, bạn đã được cảnh báo {authorwarnings} lần, hãy chú ý!<div class="quote"><blockquote>{reason}</blockquote></div>',
...
<p class="summary">Số đơn đặt hàng: <span>{orderid}</span></p><p class="summary">Chi phí: <span>VND {price}</span></p><p class="summary">Doanh thu: <span>{value}</span></p>',
	...
	'member_change_usergroup' => 'Bạn đã được thay đổi từ {user} thành nhóm người dùng {groupname} thời hạn: {day} (0: viết tắt của hiệu lực vĩnh viễn), thông tin nhóm mở rộng là {extgroupinfo} và các thay đổi liên quan được thông báo cho bạn theo yêu cầu của toán tử và lý do hoạt động là: {reason}',
	'member_change_credits' => 'Bạn đã được điều chỉnh tín dụng bởi {user}, loại tín dụng và giá trị điều chỉnh là {extcredits} và bạn được thông báo về sự thay đổi theo yêu cầu của nhà điều hành và lý do cho hoạt động này là: {reason}',
