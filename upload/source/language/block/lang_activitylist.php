...
(
	...
	'activitylist_fnamelength_comment' => 'Thiết lập độ dài tối đa tiêu đề bao gồm cả tên diễn đàn',
	'activitylist_summarylength' => 'Mô tả',
	'activitylist_summarylength_comment' => 'Thiết lập độ dài của bản mô tả, để 0 sẽ giá trị mặc ​​định (255 ký tự)',
	...
	'activitylist_keyword_comment' => 'Thiết lập các từ khóa được sử dụng. Ký tự đại diện * có thể được sử dụng trong từ khóa； Nếu bạn muốn sử dụng nhiều từ khóa cùng lúc, bạn có thể sử dụng AND. Ví dụ: win32 AND Unix.； Nếu bạn  chỉ muốn sử dụng một từ khóa, bạn có thể dùng | hoặc OR. Ví dụ: win32 OR unix',
	...
	'activitylist_recommend_comment' => 'Hiển thị chỉ những chủ đề được đề nghị',
	...
	'activitylist_orderby_weekhot' => 'Hot trong tuần',
	'activitylist_orderby_monthhot' => 'Hot trong tháng',
	'activitylist_orderby_alltimehot' => 'Khi kết thúc hoạt động đã không tham gia bất kỳ thứ tự của số lượng',
