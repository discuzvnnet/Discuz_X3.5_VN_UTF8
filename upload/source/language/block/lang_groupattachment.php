...
(
	...
	'groupattachment_fids_comment' => 'Chỉ định một nhóm, phân tách nhiều ID bằng “,”.',
	...
	'groupattachment_startrow_comment' => 'Nếu bạn cần phải thiết lập hàng đầu, vui lòng nhập một số, 0 là hàng đầu tiên.',
	...
	'groupattachment_titlelength_comment' => 'Thiết lập độ dài tối đa của tiêu đề.',
	'groupattachment_summarylength' => 'Mô tả nhóm',
	'groupattachment_summarylength_comment' => 'Thiết lập độ dài tối đa của mô tả.',
	'groupattachment_maxwidth' => 'Chiều rộng tối đa hình ảnh, px',
	'groupattachment_maxwidth_comment' => 'Thiết lập kích thước hình ảnh tối đa để thu nhỏ chiều rộng này tự động, thiết lập 0 để vô hiệu hóa zoom ảnh',
	'groupattachment_maxheight' => 'Chiều cao tối đa hình ảnh, px',
	'groupattachment_maxheight_comment' => 'Thiết lập hình ảnh tự động phóng to đến độ cao này, đặt 0 để vô hiệu hoá tính năng zoom ảnh',
	'groupattachment_threadmethod' => 'Xâu file đính kèm',
	'groupattachment_threadmethod_comment' => 'Chọn "Có" thì file đính kèm sẽ hiện dưới chủ đề, một chủ đề sẽ hiển thị một tập tin đính kèm; "Không" thì mỗi chủ đề sẽ hiện nhiều đính kèm',
	'groupattachment_digest' => 'Lọc phân loại',
	'groupattachment_digest_comment' => 'Chọn chủ đề: để có tính năng lọc chủ đề. Lưu ý: Tất cả hoặc không cho vô hiệu hoá tính năng lọc',
	...
	'groupattachment_special_comment' => 'Chọn chủ đề cần lọc đặc biệt. Lưu ý: Tất cả hoặc không cho vô hiệu hoá tính năng lọc',
