...
(
	...
	'threadlist_fnamelength_comment' => 'Thiết lập độ dài tối đa tiêu đề bao gồm cả tên diễn đàn',
	'threadlist_summarylength' => 'Mô tả danh sách bài viết',
	'threadlist_summarylength_comment' => 'Thiết lập độ dài của bản mô tả, để 0 sẽ giá trị mặc định (255 ký tự)',
	...
	'threadlist_keyword_comment' => 'Thiết lập các từ khóa được sử dụng. Ký tự đại diện * có thể được sử dụng trong từ khóa； Nếu bạn muốn sử dụng nhiều từ khóa cùng lúc, bạn có thể sử dụng AND. Ví dụ: win32 AND Unix.； Nếu bạn  chỉ muốn sử dụng một từ khóa, bạn có thể dùng | hoặc OR. Ví dụ: win32 OR unix',
	...
	'threadlist_reply' => 'Không có lọc chủ đề phản hồi',
	...
	'threadlist_viewmod' => 'Xem kiểu Portal',
	'threadlist_recommend_comment' => 'Hiển thị những chủ đề được đề nghị',
	'threadlist_picrequired' => 'Hình ảnh đính kèm',
	'threadlist_picrequired_comment' => 'Thiết lập chỉ để hiển thị các chủ đề có chứa file đính kèm hình ảnh',
