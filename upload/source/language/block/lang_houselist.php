...
(
	...
	'categorylist_showitems_comment' => 'Thiết lập số lượng hàng mà bạn muốn hiển thị, nó phải số nguyên lớn hơn 0.',
	...
	'categorylist_fnamelength_comment' => 'Thiết lập độ dài tối đa tiêu đề bao gồm cả tên diễn đàn',
	'categorylist_summarylength' => 'Mô tả',
	'categorylist_summarylength_comment' => 'Thiết lập độ dài của bản mô tả, để 0 sẽ giá trị mặc định (255 ký tự)',
	...
	'categorylist_keyword_comment' => 'Thiết lập các từ khóa được sử dụng. Ký tự đại diện * có thể được sử dụng trong từ khóa； Nếu bạn muốn sử dụng nhiều từ khóa cùng lúc, bạn có thể sử dụng AND. Ví dụ: win32 AND Unix.； Nếu bạn  chỉ muốn sử dụng một từ khóa, bạn có thể dùng | hoặc OR. Ví dụ: win32 OR unix',
	...
	'categorylist_categoryids_comment' => 'Thiết lập các phân loại chủ đề. Lưu ý: nếu chọn không sẽ vô hiệu hóa tính năng này.',
	...
	'categorylist_recommend' => 'Đề xuất chủ đề',
	'categorylist_recommend_comment' => 'Hiển thị chỉ những chủ đề được đề nghị',
