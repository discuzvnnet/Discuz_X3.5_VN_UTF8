...
$lang = array(
	...
	'block4' => 'Kiểu 4',
	'block5' => 'Kiểu 5',
	'blockdata' => array('personalinfo' => 'Thông tin cá nhân', 'profile' => 'Hình đại diện', 'doing' => 'Tâm trạng', 'feed' => 'Năng động',
				'blog' => 'Blog', 'stickblog' => 'Stick blog', 'album' => 'Album ảnh', 'friend' => 'Bạn bè',
				'visitor' => 'Khách truy cập gần đây', 'wall' => 'Bảng tin', 'share' => 'Chia sẻ',
				'thread' => 'Chủ đề', 'group'=>(isset($_G['setting']['navs'][3]['navname']) ? $_G['setting']['navs'][3]['navname'] : ''),'music'=>'Music',
	...
	'wall_form' => '<div class="space_wall_post">
						<form action="home.php?mod=spacecp&ac=comment" id="quickcommentform_{uid}" name="quickcommentform_{uid}" method="post" autocomplete="off" onsubmit="ajaxpost(\'quickcommentform_{uid}\', \'return_commentwall_{uid}\');doane(event);">
							...
							<input type="hidden" name="commentsubmit" value="true" />' : ($_G['connectguest'] ? '<div class="pt hm">Bạn cần <a href="member.php?mod=connect" class="xi2">hoàn thiện thông tin tài khoản</a> hoặc <a href="member.php?mod=connect&ac=bind" class="xi2">Bạn chỉ có thể trả lời sau khi liên kết tài khoản hiện có</a></div>' : '<div class="pt hm">Bạn cần đăng nhập trước khi có thể để lại tin nhắn <a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href)" class="xi2">đăng nhập</a> | <a href="member.php?mod='.$_G['setting']['regname'].'" class="xi2">'.$_G['setting']['reglinkname'].'</a></div>')).'
	...
	'viewthread_userinfo_doings' => 'Tâm trạng',
